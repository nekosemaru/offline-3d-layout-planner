...
- **事業・活動**: 副業・サイドプロジェクト（Offline 3D Layout Planner）
- **目標・課題**: アイデアを忘れる、収益・リリースを目指している
- **作成日**: 2026-06-16
...
- **アイデアキャプチャ最優先**: オーナーはアイデアを忘れやすいため、会話中にアイデアが出たらすぐに `secretary/inbox/` に記録する
- **リリース志向**: Offline 3D Layout Planner のリリースと収益化が当面の目標。タスク整理の際はリリースに近づく作業を優先度「高」に
- **副業ペース**: 本業の合間に進めるため、タスクは小さく砕いて進めやすくする
